                ...
                VStack(spacing: 20) {
                    ...
                    VStack(spacing: 16) {
                        ...
                        Image(systemName: viewModel.vpnState.icon)
                            ...
                            .symbolEffect(.bounce, options: .repeating, value: viewModel.vpnState == .starting || viewModel.vpnState == .stopping)
                    ...
                    .disabled(viewModel.isLoading || viewModel.vpnState == .starting || viewModel.vpnState == .stopping)
